...
[![Build Status](https://travis-ci.com/OffChainData/holiday-oracle-php.svg?branch=master)](https://travis-ci.com/OffChainData/holiday-oracle-php)
[![License](https://holidayoracle.io/images/license.svg)](https://github.com/OffChainData/holiday-oracle-php/blob/master/LICENSE)
...
To obtain a list of [supported locations](https://holidayoracle.io/docs/index.html#locations) (countries and subdivisions) call the *locations()* method.
...
The [date end point](https://holidayoracle.io/docs/index.html#date) can be used to determine if a date is a working day or holiday. It can also be used to calculate the next N working day.
...
Obtaining a list of [holidays](https://holidayoracle.io/docs/index.html#holidays) for a location is done via the *holidays()* method.
...
Lastly, to calculate [business/working days](https://holidayoracle.io/docs/index.html#business-days) between two dates, call the *businessDays()* method.
...
## Errors
The client library will throw exceptions upon validation errors and when errors are returned by the API. The exact API error code can be returned as per the following
```php
try {
    $response = $client->businessDays('2020-01-01', '2020-02-01', 'AU');
    ...
...
You can also query the API [https://holidayoracle.io/docs/index.html#locations](https://holidayoracle.io/docs/index.html#locations) for a list of currently supported locations.
